          ...
          , a = function() {
            ...
            return i(t, [{
                ...
                value: function(t, e) {
                    ...
                    // Callback when string typing is complete
                    this.options.onStringTyped(this.arrayPos, this);

                    // Make cursor blink after typing is done
                    this.toggleBlinking(!0);
                    setTimeout(function() {
                       s.toggleBlinking(false);  // Stop blinking
                       if (s.cursor) {
                           s.cursor.style.visibility = 'hidden';  // Hide the cursor
                       }
                   }, 2500);

                    // Check if we have completed typing the last string
                    if (this.arrayPos === this.strings.length - 1) {
                        // Stop typing and complete the animation
                        this.complete();

                        // If looping is disabled or the current loop count is reached, stop the animation
                        if (this.loop === !1 || this.curLoop === this.loopCount) {
                            // No backspace or further typing will occur
                            return;
                        }
                    }
                }
